...
int main(int argc, const char* * argv)
{
   ...
   fp = fopen("C:\\Users\\momin_silva\\Desktop\\loc2.txt","w");
	...
	const uint64_t y = 0x3921a39000;
	printf("Putting '%s' in memory, address %p\n", secret, (void *)(secret));
	uint64_t malicious_x = y ;//(size_t)(secret - (char *)array1); /* default for malicious_x */
	int score[2], len = 0x1000;
	uint8_t value[2];
